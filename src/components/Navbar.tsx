    ...
    <>
      <motion.nav initial={{ y: -100 }} animate={{ y: 0 }} transition={{ delay: pathname === '/' ? 2.5 : 0, duration: 0.8, ease: "easeOut" }} className="fixed top-0 left-0 right-0 z-50 bg-[#050505]/90 backdrop-blur-md border-b border-white/10 px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link href="/" className="text-gray-300 hover:text-white text-sm font-semibold transition">Início</Link>
          <Link href="/produtos" className="text-gray-300 hover:text-[#FF3366] text-sm font-semibold transition">Loja 3D</Link>
          <Link href="/carrinho" className="text-gray-300 hover:text-white text-sm font-semibold transition">Carrinho</Link>
        </div>
